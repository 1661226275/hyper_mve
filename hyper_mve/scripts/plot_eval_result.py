...
Self-contained pipeline over ``runs/eval_result/`` (per-regime reward scalars
...
ROOT_DEFAULT = pathlib.Path("runs/eval_result")
OUT_DEFAULT = pathlib.Path("runs/_analysis/rel_defense")
