"""Vendored from networks/dreamer/rnns.py. [PORT] relative imports only."""
import torch
import torch.nn as nn
from torch.distributions import OneHotCategorical

from .config import RSSMState                     # [PORT] was: configs.dreamer.DreamerAgentConfig
from .transformer_layers import AttentionEncoder  # [PORT] was: networks.transformer.layers
