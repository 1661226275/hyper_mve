...
this module is the plumbing layer that:
  ...
  * bridges :class:`hyper_mve.configs.V4Config` into the ``args``-shaped
...
from hyper_mve.baselines.external._lzj_mappo.mappo import MAPPO_MPE
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            lr: pkg-07 spec 05 §4.2 canonical kwarg — one value from
                ``cfg.baselines.external_lr_sweep_grid["external_mappo"]``.
