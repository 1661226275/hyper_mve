...
class _MAMBAStub(ExternalBaselineRunner):
    ...
    def __init__(self, cfg: V4Config) -> None:
        ...
        raise NotImplementedError(
            ...
            "hyper_mve.baselines.external.mamba.IS_SOURCED to use _RealMAMBA."
        )
...
class _RealMAMBA(ExternalBaselineRunner):
    ...
    def _build(self, obs_dim: int) -> None:
        from hyper_mve.baselines.external._mamba.config import MambaConfig
        from hyper_mve.baselines.external._mamba.learner import DreamerLearner
