...
Run from the repo root:
    ...
    python hyper_mve/scripts/make_baseline_comparison.py \
        --out results/analysis/rel_defense --assets docs/assets/interim_report
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out", type=pathlib.Path,
                    default=pathlib.Path("results/analysis/rel_defense"))
    ...
    ap.add_argument("--final-evals-dir", type=pathlib.Path,
                    default=pathlib.Path("results/analysis/rel_defense/final_evals_2m"),
