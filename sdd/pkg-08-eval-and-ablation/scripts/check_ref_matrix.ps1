# check_ref_matrix.ps1 -- Pkg-08 SDD reference-matrix machine check (Day 8 per pkg-08 README calendar)
#
# Usage:
...
# README "spec 间引用表" expected reference matrix (hand-maintained; must stay in sync with README.md lines 313-320)
$ExpectedRefs = @{
    "01-unified-evaluator"                  = @("02", "03", "04", "08")
    "02-zero-shot-and-c-hidden"             = @("01", "06", "08")
    "03-direct-inference-toggle"            = @("01", "06", "08")
    "04-mup-verification"                   = @("01", "08")
    "05-sweep-harness-and-run-registry"     = @("06", "07", "08")
    "06-ablation-cli-and-cells"             = @("03", "05", "08")
    "07-statistics-and-comparison"          = @("05", "06", "08")
...
Get-ChildItem "specs\0*.md" | Sort-Object Name | ForEach-Object {
    ...
    #     (case-insensitive negative lookbehind, per pkg-08 spec 08 #8.2 lock)
...
# Terminal summary
Write-Host "`n=== Pkg-08 SDD Reference Matrix ===" -ForegroundColor Cyan
